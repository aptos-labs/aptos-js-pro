...
<TSDoc
  definition={generateDefinition({
    code: `import { useAccountCoins } from "@aptos-labs/react";
    type UseAccountCoinsQueryResult = ReturnType<typeof useAccountCoins>;
    export default UseAccountCoinsQueryResult;
    `,
  })}
/>
